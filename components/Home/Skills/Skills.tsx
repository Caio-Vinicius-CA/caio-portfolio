...
const Skills = () => {
  return (
    <div className="text-white pt-16 pb-22">
        ...
        {skills.map((skill) => {
          return (
            <Tilt key={skill.name} scale={1.2} transitionSpeed={400}>
              <div className=" bg-[#14134145] text-center h-48 w-40 rounded-3xl flex flex-col items-center justify-center shadow-lg transition hover:scale-105">
